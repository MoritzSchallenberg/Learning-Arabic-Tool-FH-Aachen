#!/usr/bin/env node
// Entwicklungsauftrag 8 — hebt die 135 neuen Wörter der Units 11-15 vom Minimalmodell auf das
...
// scripts/data/kurs1Units11to15Full.js. Die bereits vollständigen Wörter (4/5/6/0/0 pro Unit,
// z. B. shop_money, clothing_shirt, body_head, …) werden NICHT angefasst, weil sie schlicht nicht
// in ALL_ENTRIES vorkommen.
//
// Neu gegenüber upgrade-kurs1-units6to10.js: setzt zusätzlich opposite_id (gegenseitig, auf
// beiden Wörtern des Paares) und confusion_group (nur wo im Datenmodell angegeben).
//
...
const { UNIT_11, UNIT_12, UNIT_13, UNIT_14, UNIT_15 } = require('./data/kurs1Units11to15Full.js');
const ALL_ENTRIES = [...UNIT_11, ...UNIT_12, ...UNIT_13, ...UNIT_14, ...UNIT_15];
...
// Gegenseitigkeitsprüfung: wenn A -> B, dann muss auch B -> A gelten (im Datenmodell selbst schon
// so gepflegt, hier nur zur Absicherung gegen künftige Tippfehler in kurs1Units11to15Full.js).
let asymmetric = 0;
for (const entry of ALL_ENTRIES) {
